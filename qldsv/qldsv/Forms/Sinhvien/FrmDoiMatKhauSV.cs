...
namespace qldsv.Forms.Sinhvien
{
    public partial class FrmDoiMatKhauSV : Form
    {
        ...
        private void FrmDoiMatKhauSV_Load(object sender, EventArgs e)
        {
        ...
        // Gắn sự kiện này vào chkHienMatKhau.CheckedChanged trong Designer
        ...
        private void btnDoiMatKhau_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string loi = DoiMatKhauSVBLL.DoiMatKhau(tenDangNhap, matKhauCu, matKhauMoi);
                if (loi != "")
                {
